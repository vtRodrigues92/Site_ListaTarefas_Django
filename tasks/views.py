...
def taskList(request):
    ...
    taskTodo = Task.objects.filter(done='todo', user=request.user).count()
    ...
    return render(request, 'tasks/list.html', 
        {'tasks':tasks, 'tasksrecently': tasksDoneRecently, 'tasksdone': tasksDone, 'tasksdoing': tasksDoing, 'taskstodo':taskTodo})
